...
> **A short video walkthrough of the Cedar Valley Health hybrid identity lab is coming soon.**

The video will provide a quick overview of the environment and demonstrate how the pieces fit together.

### 🔎 Quick Overview

#### The walkthrough will cover:

- 🏥 Cedar Valley Health hybrid identity scenario
- 🖥️ Windows Server 2022 and `CVH-DC01`
- 📁 Active Directory structure and Phase 8 users
- 👥 James Wilson, Ashley Brooks, and Robert Davis
- 🔄 Microsoft Entra Connect configuration
- 🔐 Password Hash Synchronization
- 🎯 OU-based synchronization scope
- ⚙️ PowerShell validation
- 🔁 Initial and delta synchronization
- ☁️ Verification of the users in Microsoft Entra ID
- 🛠️ Brief overview of the Cloud Sync troubleshooting experience
